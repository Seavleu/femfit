...
function PaymentProcessing({ orderNumber }: { orderNumber: string }) {
  return (
    <div className="mx-auto max-w-6xl px-3 pb-10 pt-6 md:px-6 md:pt-8">
      <div className="module mx-auto flex max-w-md flex-col items-center justify-center px-6 py-24 text-center">
        ...
        <h1 className="title-serif mb-2">Processing your payment</h1>
...
function PaymentFailed({ orderNumber }: { orderNumber: string }) {
  return (
    <div className="mx-auto max-w-6xl px-3 pb-10 pt-6 md:px-6 md:pt-8">
      <div className="module mx-auto flex max-w-md flex-col items-center justify-center px-6 py-24 text-center">
        <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-2xl border border-rose-femfit/30 bg-rose-femfit/10">
          <svg
            width="28"
            height="28"
            viewBox="0 0 24 24"
        ...
        <h1 className="title-serif mb-2">Payment unsuccessful</h1>
        <p className="mb-2 font-mono text-sm text-muted-foreground">
          Order {orderNumber}
        </p>
        <p className="mb-8 text-sm text-muted-foreground">
        ...
        <div className="flex flex-col gap-3 sm:flex-row">
          <Link href="/cart" className="btn-solid">
            Return to cart
          </Link>
